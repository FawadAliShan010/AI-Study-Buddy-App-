...
class _CreateNoteScreenState extends State<CreateNoteScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          if (_contentController.text.isNotEmpty)
            IconButton(
              icon: const Icon(Icons.summarize_rounded, color: Colors.white70),
      ...
      child: ElevatedButton(
        ...
        child: _isLoading
          ...
          child: CircularProgressIndicator(
            ...
            : Text(
          widget.noteId == null ? 'Create Note' : 'Update Note',
          style: const TextStyle(
            fontSize: 16,
            fontWeight: FontWeight.bold,
          ),
  ...
  Future<void> _summarizeContent() async {
    ...
    try {
      final summary = await GroqApiService().summarizeText(content);
      setState(() {
